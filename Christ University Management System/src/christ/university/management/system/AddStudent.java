...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent(){
        ...
        String course[]={"select new","B.Tech in CS","BBA","BPsych","BTech in DS","BTech in Iot","Btech in AIML","Btech in RAM","Btech in CE","Btech in ME","Btech in EE","MBA","Mtech"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== submit){
           ...
           try{
               String query = "Insert into student values('"+name+"','"+fname+"','"+rollnumber+"','"+dcob1+"','"+addname+"','"+mobilenum+"','"+emailid+"','"+xmarks+"','"+xiimarks+"','"+aadhar+"','"+courses+"','"+genders+"');";
               Conn con =new Conn();
