...
public class UpdateStudent extends JFrame implements ActionListener{
    JLabel heading,heading1,name,f,n,fn,roll,rn,dob,dcob,add,Mn,em,x,xii,tfx,xiin,adh,adhn,co,g,gc;
    JTextField addn,mn,emn,c;
    Choice crollno;
    ...
    UpdateStudent(){
        ...
        crollno.addItemListener(new ItemListener(){
            ...
            while(rs.next()){
                ...
                rn.setText(rs.getString("roll_number"));
                ...
                xiin.setText(rs.getString("class_xii"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== submit){
           ...
           String courses= c.getText();
           try{
               String query = "update student set address='"+addname+"',phone='"+mobilenum+"',email='"+emailid+"',course='"+courses+"' where roll_number = '"+roll+"';";
               Conn con =new Conn();
